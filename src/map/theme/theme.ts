...
export function getThemes(map, render: MapRender, type): Array<BaseTheme> {
    let themes = [];
...
export function getThemeById(map, render: MapRender, id: string): BaseTheme {
...
export function getThemeByArray(array: Array<BaseTheme>, name: string) {
...
export function setTheme(id, theme, map, render: MapRender, type) {
    if (render == MapRender.MapBoxGL) {
        const { layers } = map.getStyle();
