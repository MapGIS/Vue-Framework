...
import { Bounds, defaultBounds, Position, defaultPosition } from "./map";
...
export class IDocument {
    ...
    maprender: MapRender;                //渲染引擎
    backgrounds: Array<BackGroundLayer>; //背景图层组
    layers: Array<ILayer>;               //图层/图层组
    sources: Object;                     //数据源数组;
    service?: Object;                    //服务数组;
    sprite?: string;                     //地图库
    glyphs?: string;                     //字体库
    center?: Position;                   //中心点
    bounds?: Bounds;                     //地图当前边界
    maxbounds?: Bounds;                  //地图最大边界
